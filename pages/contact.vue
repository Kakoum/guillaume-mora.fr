  ...
  <div>
      <div class="flex flex-col lg:flex-row">
        <div class="lg:w-6/12 mb-10 lg:mb-0">
          <h1 class="text-5xl font-bold mb-10 text-slate-100">Me contacter</h1>
          <p class="font-light lg:mr-20">
            Vous pouvez me contacter via mes réseaux ou en passant directement par le formulaire !
          </p>
          <div class="flex mt-4">
            <div class="h-6 w-6">
              <svg fill="#26ccce" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><title/><g data-name="8-Email" id="_8-Email"><path d="M45,7H3a3,3,0,0,0-3,3V38a3,3,0,0,0,3,3H45a3,3,0,0,0,3-3V10A3,3,0,0,0,45,7Zm-.64,2L24,24.74,3.64,9ZM2,37.59V10.26L17.41,22.17ZM3.41,39,19,23.41l4.38,3.39a1,1,0,0,0,1.22,0L29,23.41,44.59,39ZM46,37.59,30.59,22.17,46,10.26Z"/></g></svg>
            </div>
            <span class="leading-6 ml-4">mora.guillaumek@gmail.com</span> 
          </div>
          <ul class="mt-8">
            <li class="inline-block">
              <a title="LinkedIn" class="btn-three" target="_blank" href="https://www.linkedin.com/in/guillaume-mora-b65753153/">
                <svg fill="white" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <li class="inline-block ml-4">
              <a title="Drupal" class="btn-three" target="_blank" href="https://www.drupal.org/u/kakoum">
                <svg fill="white" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                  <title>Drupal</title>
            ...
            <li class="inline-block ml-4">
              <a title="Github" class="btn-three" target="_blank" href="https://github.com/Kakoum">
                <svg fill="white" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                  <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                  <title>Github</title>
