<template>
  <div>
    <h1 class="font-bold mb-2">Guillaume,</h1>
    <h2 class="font-bold mb-10 text-main">Développeur web indépendant</h2>
    <p class="font-light md:w-4/5 lg:w-3/5">
      Passionné par le web depuis belle lurette, je travaille aujourd'hui en tant que développeur web.<br>
